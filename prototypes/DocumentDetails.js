...
export class DocumentDetails extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.navigation.addListener('blur', () => this._didBlur());
  }

  _willFocus() {
    this.DEF_STATE.id = CommonFunctions.getDocumentID(this.PREFIX_ID);
    this.DEF_STATE.date = new Date();
    this.setState(this.props.navigationOptions?.document || this.DEF_STATE);
  ...
  _goBack = () => {
    ...
    // this.props.route.params.previousScreen || this.LIST_SCREEN,
    return true;
  };
